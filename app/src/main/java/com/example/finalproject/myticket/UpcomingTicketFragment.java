...
public class UpcomingTicketFragment extends Fragment {
    ...
    public static UpcomingTicketFragment newInstance(String param1, String param2) {
        UpcomingTicketFragment fragment = new UpcomingTicketFragment();
