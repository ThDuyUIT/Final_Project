...
public class CompletedTicketFragment extends Fragment {
    ...
    public CompletedTicketFragment() {
    ...
    public static CompletedTicketFragment newInstance(String param1, String param2) {
        CompletedTicketFragment fragment = new CompletedTicketFragment();
